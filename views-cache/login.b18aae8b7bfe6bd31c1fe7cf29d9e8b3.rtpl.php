...
<head>
  ...
  <title>Compra.co.mz | Log in</title>
...
<div class="login-box">
  <div class="login-logo">
    <a href="/res/admin/index2.html"><b>Compra</b>.co.mz</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <form action="/admin/login" method="post">
      <div class="form-group has-feedback">
        <input type="text" class="form-control" placeholder="Nome Utilizador" name="login">
