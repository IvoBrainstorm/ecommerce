            ...
            <div class="col-md-3 col-sm-6">
                <div class="footer-about-us">
                    ...
                    <div class="footer-social">
                        <a href="https://www.facebook.com/Comprabr" target="_blank"><i class="fa fa-facebook"></i></a>
                        <a href="https://twitter.com/Comprabr" target="_blank"><i class="fa fa-twitter"></i></a>
...
<div class="footer-bottom-area">
    <div class="container">
        <div class="row">
            <div class="col-md-8">
                <div class="copyright">
                    <p>&copy; 2020 Compra. <a href="#" target="_blank">compra.co.mz</a></p>
                </div>
            </div>
